...
- Create Angular project with ng: `ng new mj_calculadora.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`mj_calculadora.client.esproj`).
